...
// based on https://github.com/ReiniervdL/Vinduino/blob/master/Vinduino-R3/Vinduino-LoRaWAN-TTN/Vinduino-LoRaWAN-TTN.ino
...
void soilsensors() {
  ...
  double read1 = average();
  if ((read1 >200) && (read1 < 25000))
  {tension1 = 0.0000002*pow(read1,2) + 0.0036*read1;}  //calibration equation for Watermark 2018 sensor
  else {tension1 = 0;}
  ...
  double read2 = average();
  if ((read2 >200) && (read2 < 25000))
  {tension2 = 0.0000002*pow(read2,2) + 0.0036*read2;}  //calibration equation for Watermark 2018 sensor
  else {tension2 = 0;}
  ...
  double read3 = average();
  if ((read3 >200) && (read3 < 25000))
  {tension3 = 0.0000002*pow(read3,2) + 0.0036*read3;}  //calibration equation for Watermark 2018 sensor
  else {tension3 = 0;}
  ...
  double read4 = average();
  if ((read4 >200) && (read4 < 25000))
  {tension4 = 0.0000002*pow(read4,2) + 0.0036*read4;}  //calibration equation for Watermark 2018 sensor
  else {tension4 = 0;}
  ...
  delay (10);
  analogRead(3);   // read the battery voltage
  delay (10);
  analogRead(3);   // read the battery voltage
  delay (10);
  Vsys = analogRead(3)/168.5*50;   // read the battery voltage
  delay (10);
